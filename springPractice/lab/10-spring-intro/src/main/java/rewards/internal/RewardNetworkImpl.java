...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		final String creditCardNum = dining.getCreditCardNumber();
		final String merchantNumber = dining.getMerchantNumber();
		Account account = accountRepository.findByCreditCard(creditCardNum);
